...
const cards = [
    {
        key: 'group1',
        children: <img alt='гимнастки начальной подготовки' src='./images/group1.jpg' />,
    ...
    {
        key: 'group2',
        children: <img alt='гимнастки среднего уровня подготовки' src='./images/group2.jpg' />,
    ...
    {
        key: 'group3',
        children: <img alt='гимнастки продвинутого уровня' src='./images/group3.jpg' />,
        groupName: 'Сборная учебно-тренировочная группа  художественной гимнастики',
        content: [
            {
                key: 'g3',
                head: <h3>Абонемент на <span>8 тренировок</span></h3>,
                body: ['3 раза в неделю по 2 часа - 7000 р.', 'Разовых посещений нет', 'Попасть в группу можно после согласования с тренерским составом и успешного прохождения испытательного срока.']
            },
        ]
    },
]
